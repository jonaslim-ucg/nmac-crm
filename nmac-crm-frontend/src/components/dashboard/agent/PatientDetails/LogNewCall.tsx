    ...
    <div className="w-full max-w-sm bg-white rounded-2xl p-6 border border-gray-200">
      ...
      <div className="space-y-5">
        ...
        <button
          ...
          className="w-full bg-gray-900 hover:bg-gray-800 active:bg-gray-950 text-white rounded-full py-2.5 px-6 flex items-center justify-center gap-2 transition-colors mt-6"
        >
