...
const SendEmailModal: React.FC<SendEmailModalProps> = ({ isOpen, onClose, patientEmail }) => {
            ...
            <div className="bg-white rounded-2xl w-full max-w-lg overflow-hidden shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">BCC (comma separated)</label>
                            <input
                                type="text"
                                value={formData.bcc}
