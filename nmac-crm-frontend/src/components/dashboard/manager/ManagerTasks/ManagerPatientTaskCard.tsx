...
const ManagerPatientTaskCard: React.FC<DashboardCardProps> = ({
  title,
  value,
  subtitle,
  icon,
  ...
  return (
    <div className={`${bgColor} rounded-3xl p-4 flex flex-col h-full border border-gray-200`}>
      ...
      <div className="flex items-center justify-between mb-8">
        <h3 className="text-base font-semibold text-[#171C35]">{title}</h3>
...
export default ManagerPatientTaskCard;