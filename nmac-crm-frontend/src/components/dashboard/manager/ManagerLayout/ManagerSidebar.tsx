...
const ManagerSidebar: React.FC<SidebarProps> = ({
  ...
  const menuItems = [
    ...
    { icon: User, label: 'Patients', path: '/dashboard/manager/patients' },
    { icon: ClipboardList, label: 'Tasks', path: '/dashboard/manager/tasks' },
    { icon: Phone, label: 'Call Logs', path: '/dashboard/manager/call-logs' },
    { icon: MessageSquare, label: 'Messages', path: '/dashboard/manager/messages' },
    { icon: ChartColumnIncreasing, label: 'Reports', path: '/dashboard/manager/reports' }
  ];
