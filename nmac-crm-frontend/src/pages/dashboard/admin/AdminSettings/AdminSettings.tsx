...
import AdminNotifications from '../../../../components/dashboard/admin/AdminSettings/AdminNotifications';
import AdminPasswordSecurity from '../../../../components/dashboard/admin/AdminSettings/AdminPasswordSecurity';
import AdminReportData from '../../../../components/dashboard/admin/AdminSettings/AdminReportData';
import { useGetUserProfileQuery, useUpdateProfileMutation } from '../../../../redux/services/auth/auth.api';
import Spinner from '../../../../components/Spinner';
import Swal from 'sweetalert2';

type TabType = 'profile' | 'notifications' | 'report' | 'security';
...
const AdminSettings: React.FC = () => {
  ...
  useEffect(() => {
    ...
    } else if (location.search.includes('report')) {
      setActiveTab('report');
    }
  ...
  //   if (typeof formData.photo === 'string' && formData.photo.length > 0) {
  //     // setPreview(formData.photo);
  ...
  const tabs = [
    ...
    { id: 'report' as TabType, label: 'Report & Data Settings' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div>
                  ...
                  <p className='text-gray-400 mt-1 text-sm font-normal'><em>This field cannot be changed</em></p>
                </div>
              </div>
            </div>

            <div className="lg:w-1/2 lg:pr-3 -mt-5">
              <label className="block text-md font-normal text-[#364153] mb-2">
                Phone Number
              </label>
              <div className="relative">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="w-full p-2">
        ...
        {/* Content Card */}
        <div className="rounded-3xl border-2 border-gray-200 p-4">
